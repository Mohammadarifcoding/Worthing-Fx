...
const SecureBox = () => {
    ...
    const handleAccess = () => {
        ...
        if (userName == 'WorthingFx' && userPassword == 'Acess123') {
            ...
            <div className="bg-gray-800 p-6 rounded-md">
                ...
                <form onSubmit={(e) => e.preventDefault()}>
                    <div className="mb-4  md:w-[500px] sm:w-[450px] w-[300px]">
                        ...
                        <input type="text" id="userName" value={userName} onChange={handleUserNameChange} className="w-full p-2 border rounded-md text-black" />
                    </div>
                    <div className="mb-4 w-full">
                        <label htmlFor="userPassword" className="block text-sm mb-1">
                            Password:
                        </label>
                        <input type="password" id="userPassword" value={userPassword} onChange={handleUserPasswordChange} className="w-full p-2 border rounded-md text-black" />
                    </div>
